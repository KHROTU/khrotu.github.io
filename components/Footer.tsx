        ...
        <footer id="contact" className="bg-gray-900 py-16">
            <div className="container mx-auto px-6 text-center">
                ...
                <a
                    ...
                    className="inline-block bg-cyan-500 hover:bg-cyan-600 text-white font-bold text-xl py-4 px-10 rounded-lg transition-all duration-300 mb-10"
                >
                    Say Hello
                </a>
                <div className="flex justify-center space-x-6 mb-8">
                    ...
                    <a
                        href="https://www.linkedin.com/in/mohan-yan-43905437b/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-400 hover:text-white transition-colors duration-300"
                    >
                ...
                <p className="text-gray-500 text-sm">
                    © {new Date().getFullYear()} KHROTU. All rights reserved.
                </p>
            </div>
        </footer>
    )
