---
title: CQB For Dummies
date: '2026-05-19'
slug: cqb-for-dummies
---

This is mostly just a summary of [this playlist](https://www.youtube.com/watch?v=RtEem87XU4s&list=PLsl5bjxREeoSSb4ccJ2YB1QUVgcZS-S9k) so I don't need to sift through footage every single time.
...
1. Active Armed Threats: individuals actively presenting a weapon or engaging in hostile action. Unless they are already engaging you, you should try to make them surrender first.
2. Unarmed Individuals: individuals without visible weapons. Must be controlled and secured, keeping in mind this category includes both civilians and potential enemy combatants.
3. Uncleared Spaces: parts of the room that have not yet been cleared.
4. Open Door/Doorways: potential entry point/escape for enemy combatants. Need to be secured.
5. Closed Door: dealt with as normal after everything else has been cleared.
6. Deceased Individuals: do I really need to explain this one?
