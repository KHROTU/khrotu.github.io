    ...
    <main className="max-w-6xl md:ml-[10%] lg:ml-[12%] px-6 py-20 md:py-32 flex flex-col gap-24">
      <section className="flex flex-col gap-8">
        ...
        <p className="text-lg md:text-xl text-[var(--text-muted)] leading-relaxed whitespace-nowrap">
          i&apos;d like to think i&apos;m a relatively competent dev; dabbles in ai/ml now and then; singaporean
        </p>
      </section>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card 
              ...
              desc="a text-conditional 3D diffusion model in pytorch for generating minecraft schematics from natural language prompts"
              time="2025"
            />
          </div>
        </div>
